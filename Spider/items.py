...
class EchoChannelItem(scrapy.Item):
    ...
    def get_insert_sql(self):
        insert_sql = """
          insert into channel_copy2(id,name,pic,info,type,tag_id,sound_count,follow_count,like_count,share_count,user_id,update_user_id,list_order,create_time,update_time,status,desp,pic_100,pic_200,pic_500,pic_640,pic_750,pic_1080)
